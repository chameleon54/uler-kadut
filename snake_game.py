...
class Button:
    ...
    def is_clicked(self, mouse_pos, mouse_click, click_sound=None):
...
class SnakeGame:
    def __init__(self):
        ...
        pygame.mixer.music.play(-1)  # Loop forevaaaa
    ...
    def move_snake(self):
        ...
        if new_head in self.snake:
            self.game_over = True
            pygame.mixer.Sound.play(self.gameover_sound)  # 💀 Game over sound
            return
        self.snake.insert(0, new_head)
        if new_head == self.food:
            self.score += 1
            self.food = self.spawn_food()
            pygame.mixer.Sound.play(self.eat_sound)  # 🐍 Eat sound
        else:
            self.snake.pop()
    ...
    def main_menu(self):
        ...
        while self.state == "menu":
            ...
            for button in buttons:
                ...
                if button.is_clicked(mouse_pos, mouse_click, self.click_sound):
